...
d_to_rgb = np.array([
    [9.9996518012567637e-01,  2.6765126468950343e-03, -
        7.9041012313000904e-03, -2.5558943178152542e-02],
    ...
    def process_frames(split_file):
        ...
        for seq in split:
            ...
            for d_index, d_file in enumerate(depth_files):
                ...
                registered_depth = np.ones(
                    (img_h, img_w), dtype=np.float32) * 2e3
                ...
                with warnings.catch_warnings():
                    ...
                    io.imsave(ds + '/' + seq + '/' + d_file.replace("depth.png",
                              "depth.proj.png"), registered_depth)
